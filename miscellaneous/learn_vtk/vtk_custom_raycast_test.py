...
def main():
    ...
    renWin_second = vtkRenderWindow()

    renWin = vtkRenderWindow()
    renWin.AddRenderer(ren1)
    #renWin_second.AddRenderer(ren1)
...
#    renWin_second.SetSize(2400, 1800)
#    renWin_second.SetWindowName('SimpleRayCast')
#    renWin_second.Render()
...
def get_program_parameters():
    ...
    parser.add_argument('--filename', help='ironProt.vtk', default='RM06_s128_c13_f8906_p3.tif')
    args = parser.parse_args()
    #/media/xyy/DATA/VISoRData/RM06_set2020-09-19/RM06_s128_c13_f8906_p3.tif
